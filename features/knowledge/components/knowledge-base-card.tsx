...
export function KnowledgeBaseCard({
  ...
  return (
    <div className="flex flex-col justify-between rounded-xl border border-border bg-card p-5 shadow-xs transition-colors hover:border-border/80">
      ...
      <div className="mt-auto flex items-center gap-2 border-t border-border pt-3">
        <Button
          variant="outline"
          size="sm"
          render={<Link href={`/knowledge/${knowledgeBase.id}`} />}
          nativeButton={false}
          className="flex-1"
        >
          Open
